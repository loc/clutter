...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString $TAG" $SCRIPT_DIR/../$PRODUCT_NAME/$PRODUCT_NAME-Info.plist
...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString DEVELOPMENT" $SCRIPT_DIR/../$PRODUCT_NAME/$PRODUCT_NAME-Info.plist
